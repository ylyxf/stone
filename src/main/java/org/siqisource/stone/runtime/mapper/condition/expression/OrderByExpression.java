...
import org.siqisource.stone.runtime.mapper.utils.NameConvertStyle;
...
public class OrderByExpression {
	...
	private void order(String propertyNames, String direction) {
		...
		for (String property : propertyNameArray) {
			...
			order.setField(NameConverter.convertWithNamespcae(property, NameConvertStyle.camelToUnderlineLower));
